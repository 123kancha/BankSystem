...
public class Deposit extends JFrame implements ActionListener{
    ...
    Deposit(String pinnumber){
        ...
        JLabel text = new JLabel("Enetr the amount you want to deposit");/*flable ke help se hum kuch bhi content likh sake h frame pe*/
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== deposit){
           ...
           //String pinnumber= pinTextField.getText();
               ...
               String query;
               query = "insert into bank values(pinnumber,'"+date+"',Deposit,'"+number+"')";
                
                JOptionPane.showMessageDialog(null,"Re "+number+" Deposit Successfully");
                setVisible(false);
